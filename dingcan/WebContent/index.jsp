...
<c:forEach items="${hotprolist}" var="bean">
<tr>
<td>
<a href="####" onclick="productshow(${bean.id })"> 
<img src="uploadfile/${bean.imgpath }" width="100" height="100"border="0" />
</a>
</td>
<td><a href="####" onclick="productshow(${bean.id })"> ${bean.name}</a></td>
<td>原价：${bean.price1 }</td>
<td>热卖价:${bean.price2 }</td>
<td>
<a href="####" onclick="cartaddshow(${bean.id })">
