...
function logout(){
	...
	top.location = "houtaimethod!loginout";
	return false;
}
</script>
...
<table width="100%" height="50" border="0" cellpadding="0" cellspacing="0" class="admin_topbg">
  <tr>
    <td width="61%" height="50"><span style="color: yellow;font-size: 25px;">美食订餐管理后台</span></td>
    <td width="39%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="74%" height="38" class="admin_txt"><b></b> 您好,${manage.truename }感谢登陆使用！</td>
